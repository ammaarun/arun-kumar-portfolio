  ...
  return (
    <div className="min-h-screen bg-[#0a0d14] text-slate-100 font-sans flex flex-col md:flex-row">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-emerald-400 font-mono">PORTFOLIO CMS</span>
              </div>
            </div>
      ...
      <div className="flex-1 md:pl-64 flex flex-col min-h-screen">
        ...
        {/* Top Navbar */}
        <header className="sticky top-0 z-30 bg-[#0a0d14]/90 backdrop-blur-md border-b border-slate-800 px-6 py-4 flex items-center justify-between">
